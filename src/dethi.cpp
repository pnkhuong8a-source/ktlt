/*File dethi.cpp chịu trách nhiệm:
Tạo đề thi
Đọc/Ghi đề thi từ file
Sửa đề thi
Xóa đề thi
Thêm/Xóa câu hỏi trong đề
Sinh đề ngẫu nhiên từ ngân hàng câu hỏi
...
DeThi*
CauHoi*
=> Trả về địa chỉ phần tử trong Vector.
6. Randomization
shuffleInt()
=> Dùng để:
        tạo đề ngẫu nhiên
...
=> Lưu:
        ngày tạo
        ngày chỉnh sửa
8. Quan hệ dữ liệu (Data Relationship)
Đề thi không chứa toàn bộ câu hỏi, mà chỉ chứa ID câu hỏi
=> Đây là kỹ thuật tham chiếu dữ liệu (ID Reference), giúp:
    tiết kiệm bộ nhớ
    tránh lưu trùng nội dung câu hỏi
    khi sửa câu hỏi trong ngân hàng thì đề thi tự cập nhật theo
*/
#include <iostream>
#include <cstring>
#include <cstdio>
